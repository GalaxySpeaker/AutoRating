...
|------|------|------|
| **Position / 位置** | X / Y | Drag the slider to adjust UI position on screen / 拖动滑块调整 UI 在屏幕上的位置 |
...
| | Speed / Rhythm / Stamina / 速度/节奏/耐力 | Displays sub-ratings (Speed → FinalSpeed, etc.) / 显示各项子评级（Speed → FinalSpeed 等） |
| | Only Show in Gameplay / 仅在游戏中显示 | Only show during gameplay, hidden in level selection / 只在打歌时显示，选关界面隐藏 |
| **Hotkey / 快捷键** | Enable / Disable / 启用/禁用 | Toggle hotkey on/off / 开关快捷键 |
| | Key: Current Key / 按键：当前按键 | Displays the current hotkey / 显示当前快捷键 |
| | Ctrl / Alt / Shift | Modifier keys / 组合键修饰 |
...
| **TUF: G5** | TUF tier label (P1–P20, G1–G20, U1–U20, PGU100) / TUF 等级标签（P1–P20, G1–G20, U1–U20, PGU100） |
| **GG: 20.2** | GG rating number / GG 评级数字 |
